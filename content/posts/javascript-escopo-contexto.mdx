---
title: JavaScript: Escopo X Contexto
date: 2020-02-05
---

Existem conceitos no JS (JavaScript) que acabam sendo muito confundidos. Um deles que acaba sendo muito recorrente é diferenciar Escopo de Contexto. Este artigo é baseado nos vídeos da série _[What Makes Javascript Weird...and Awesome](https://www.youtube.com/playlist?list=PLoYCgNOIyGABI011EYc-avPOsk1YsMUe_)_ do canal do YouTube _[LearnCode.academy](https://www.youtube.com/learncodeacademy/).\_
...
As variáveis com um escopo maior, podem ser acessadas por escopos menores. O termo correto é _Parent scope_ para o escopo mais alto e para o escopo menor é _Child scope._ Porém isto não acontece inversamente, ou seja, váriaveis em escopos filhos não podem ser acessadas por escopos pai, veja o trecho a seguir:
...
Lembrando que este maravilhoso blog encontra-se em código aberto no meu GitHub. Caso queira ver o código ou realizar alguma melhoria. Eu agradeço 😄
