...
Existem conceitos no JS (JavaScript) que acabam sendo muito confundidos. Um deles que acaba sendo muito recorrente é diferenciar Escopo de Contexto. Este artigo é baseado nos vídeos da série [What Makes Javascript Weird...and Awesome](https://www.youtube.com/playlist?list=PLoYCgNOIyGABI011EYc-avPOsk1YsMUe_) do canal do YouTube [LearnCode.academy](https://www.youtube.com/learncodeacademy/).
